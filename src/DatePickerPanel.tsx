...
import { isDateISO, isDateFormat, formatDate, dateParse } from "./date";
...
export function DatePickerPanel(props: DatePickerPanelProps) {
    ...
    const date = isDate(inputValue) || !inputValue ? inputValue : lastRef.current;
    ...
    function changeValue(v: string) {
        const val = isDate(v) || !v ? v : lastRef.current;
        lastRef.current = val;
